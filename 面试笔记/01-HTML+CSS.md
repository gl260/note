...
* margin-top传递
  ...
  * 有几种解决办法
    ...
    * 2: 激活父元素的BFC(后面会讲) overflow: auto
...
其实在现代工程化的开发架构下，大多数的浏览器兼容性问题是可以通过工程话中的配置选项来解决的
...
## 44.  CSS 优化和提高性能的方法有哪些？

* 加载性能
  * css压缩: 利用`webpack`、`gulp/grunt`、`rollup`等模块化工具，将`css`代码进行压缩，使文件变小，大大降低了浏览器的加载时间
